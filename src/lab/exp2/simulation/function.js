window.view = {
	...
	displayFunctionForRectangle: function() {
		document.getElementById('functionRectangle').innerHTML += 'float area_right_angle_triangle (float a,float b)<br>{<br> &emsp; float area = a*b/2;<br> &emsp; return area;<br>}'
	},
